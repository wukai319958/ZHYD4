...
namespace SFBR.Data.Api
{
    public class Program
    {
        ...
        public static readonly string AppName = "SFBRDataApi";
        ...
        private static void Run(string[] args)
        {
            ...
            HostFactory.Run(config =>
            {
                ...
                config.SetDescription("四方博瑞数据采集API服务2.0");
                config.SetDisplayName("四方博瑞数据采集API服务2.0");
                config.SetServiceName("SFBR_Data_Api2");
