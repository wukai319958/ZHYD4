...
namespace SFBR.Device.Api.Application.IntegrationEvents.Events
{
    ...
    {
        public DeviceOnLineIntegrationEvent(string deviceId, string deviceName, string deviceTypeCode, string modelCode, string equipNum, string regionId, string regionCode, 
            string regionName, string tentantId, string tentantName, string parentId)
        {
            ...
            ParentId = parentId;
            AlarmCode = DeviceOffLineIntegrationEvent.OffLine;
            ClearReason = 0;
            ClearTime = DateTime.UtcNow;
            Description = $"{regionName}编号为{equipNum}的站点已上线！";
        }
