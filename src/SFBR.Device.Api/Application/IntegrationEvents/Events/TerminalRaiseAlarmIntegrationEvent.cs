...
namespace SFBR.Device.Api.Application.IntegrationEvents.Events
{
    ...
    {
        public TerminalRaiseAlarmIntegrationEvent(string deviceId, string deviceName, string deviceTypeCode, string modelCode, string equipNum, string regionId, string regionCode, string regionName, string tentantId, string tentantName, string parentId, double latitude, double longitude, Alarm alarm)
        {
    ...
    public class Alarm
    {
        public Alarm(string logId, string alarmCode, string alarmName, string groupName, int alarmType, int alarmFrom, string targetCode, int alarmLevel, string alarmStatus, string description, double repairTime, DateTime alarmTime, bool isStatistics, double? realData, double? upperLimit, double? lowerLimit)
        {
            ...
            AlarmStatus = alarmStatus ?? throw new ArgumentNullException(nameof(alarmStatus));
